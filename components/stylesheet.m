function stylesheet(microphone, isPause, amplitude, periods, isJitter, isGaussian, isEcho, isAwg)
%---Program window---%
...
editAmplitude=uieditfield(fig,"numeric", ...
               'Position', [220 750 150 30],...
               'Value', amplitude,...
               "ValueDisplayFormat","%.2f Amplitudine",...
               "ValueChangedFcn",@(value,event) amplitudeChanged(value));

editNumberOfPeriods=uieditfield(fig,"numeric", ...
               'Position', [400 750 150 30],...
               'Value', periods,...
               "ValueDisplayFormat","%.2f Perioade",...
               "ValueChangedFcn",@(value,event) periodsChanged(value));
...
MicrophoneBox = uicheckbox(fig, 'Text','Microphone',...
                  'Value', 0,...
                  'Position',[320 500 150 30],...
                  "ValueChangedFcn",@(value,event) microphoneChanged(value));
...
'Callback',{@(h,e) reset});
    ...
    function microphoneChanged(value)
